...
MEAL_PHOTOS = [
"https://images.unsplash.com/photo-1531234799389-dcb7651eb0a2?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=9b7241fbbe99b4ec1d78702da958eeb3&auto=format&fit=crop&w=1950&q=80",

"https://images.unsplash.com/photo-1524182576066-1bb979e25342?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=fdd66ce8c595d2f8883284a6b47b1506&auto=format&fit=crop&w=1950&q=80",

"https://images.unsplash.com/photo-1485963631004-f2f00b1d6606?ixlib=rb-0.3.5&s=bb1405c74c839e21a352ab35567590ae&auto=format&fit=crop&w=1568&q=80",

"https://images.unsplash.com/photo-1473093295043-cdd812d0e601?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=c9443baefd581d4e532b6d4f1e7879be&auto=format&fit=crop&w=1950&q=80",
...
B_DIRECTIONS =
  ...
  Bring the coconut milk to a boil in a medium stockpot.
  Add the coconut and season with salt and pepper.
  Cover the pot, remove from the heat, and let stand 10 minutes.
  Finally, stir in the scallion, parsley, mint, and pumpkin seeds.
  Meanwhile, season both sides of the salmon with blackening seasoning.
  Place the fish on a parchment lined baking sheet, until just cooked through but still medium-rare in center, about 10 minutes.
  Make a bed of parsley, place the fish on top, tear up some extra mint leaves for garnish, and serve with lemon wedges (optional)."
...
L_DIRECTIONS = "To make the dressing, tip all the ingredients and 4 of the torn lime leaves in a small saucepan and bring to a simmer.
Boil for 1 min, then remove from the heat to infuse.
...
Taste the noodles, adding a splash more vinegar, soy or sesame oil to suit your taste. Pile the noodles onto a platter or into a large bowl.
...
D_INGREDIENTS = [
  ...
  "mustard",
  "ketchup",
  "secret formula (can only be found in the patty vault)"
]

D_DIRECTIONS = [
  "Place the chopped onions and celery into a skillet or frying pan. Sauté in 1 tablespoon of oil.
  Reduce the heat and cook gently until the onions wilt, or appear transparent. Avoid browning or burning them.
  Mix the pickles, sauteed onions, see cheese, mustard, salt, and pepper in a mixing bowl.
  ...
  Heat 3 tablespoons of oil. Cook the patties in batches of 2 to 3 at a time.
  Cook each patty 2 minutes each side, or until the patties are golden brown. Keep adding oil for following batches as needed
  Preheat the oven to 200ºC/400ºF. Add the fried Krabby patties to the oven for a 10 minute bake.
  Place patties inside bun with lettuce and ketchup"
]
